...
module attributes {tf_saved_model.semantics, tosa.description = "Tosa FBS Converted", tosa.fbs_version = "0.60.0"} {
    func.func @main(%arg0: tensor<1x32x32x23xi8> {tf_saved_model.index_path = ["input_0"]}) -> (tensor<1x32x32x5xi32> {tf_saved_model.index_path = ["output_0"]}) attributes {tf.entry_function = {inputs = "tosa_deserialized_input_0:0", outputs = "tosa_deserialized_output_0:0"}, tf_saved_model.exported_names = ["tosa_deserialized"]} {
    ...
    %2 = "tosa.const"() {values = dense<"0x00003758005B00580000250000CC00007600E2004A4F000000006C560000002500DE0075470000007A004C0000"> : tensor<5x3x3x1xi8>} : () -> tensor<5x3x3x1xi8>
    ...
    return %11 : tensor<1x32x32x5xi32>
    }
}
